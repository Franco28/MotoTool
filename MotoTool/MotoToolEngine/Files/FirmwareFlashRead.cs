...
namespace Franco28Tool.Engine
{
    public class FirmwareFlashRead
    {
        ...
        public static string fwbl1 = "";
        public static string ldfw_a = "";
        public static string ldfw_b = "";
        public static string keystorage_a = "";
        public static string keystorage_b = "";
        public static string oem = "";
        public static string gpt = "";
        public static string preloader = "";
        public static string bootloader = "";
        public static string bootloader_b = "";
                            ...
                            if ((reader.NodeType == XmlNodeType.Text) && (reader.HasValue))
                            {
                                switch (elementName)
                                {
                                    ...
                                    case "ldfw_b":
                                        ...
                                        break;
                                    case "keystorage_a":
                                        keystorage_a = reader.Value;
                                        break;
                                    case "keystorage_b":
                                        keystorage_b = reader.Value;
                                        break;
                                    case "dtbo_a":
                                        dtbo_a = reader.Value;
                                        break;
